...
if __name__ == "__main__":
    ...
    trainer.add_argument(
        "--filter_agreement", action="store_true", help="Filter for agreement between both participants."
    )
    ...
    train_loader = DataLoader(
        train_dataset, batch_size=args.batch_size, shuffle=True, drop_last=True, num_workers=args.worker
    )

    val_loader = DataLoader(val_dataset, batch_size=1, shuffle=False, num_workers=args.worker)
